...
cars_train, cars_test = train_test_split(pickle_in, test_size = 0.2) # 20% test data

# preparing the model on train data 
model_train = smf.ols("Competitor_Price ~ Maintenance_cost + Marketing_cost + Debentures + Profit_Margin", data = cars_train).fit()
